...
impl Graph3D {
    ...
    pub fn render(
        ...
        let my_3d_matrix = cf::get_3d_matrices(
            bottom,
            top,
            left,
            right,
        ...
        gl.uniform_matrix4fv_with_f32_array(Some(&self.u_projection), false, &my_3d_matrix.projection);
        gl.uniform_matrix4fv_with_f32_array(
            Some(&self.u_normals_rotation),
            false,
            &my_3d_matrix.normals_rotation,
        );
